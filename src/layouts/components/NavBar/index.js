...
function NavBar() {
    return (
        <div className={`navbar ${styles.navbar}`}>
            ...
            <div className={styles.navItem}>
                <NavLink to="/khuyen-mai" className={({isActive}) => isActive ? `${styles.active}` : null}>Về chúng tôi</NavLink>
            </div>
            <div className={styles.navItem}>
                <NavLink to="/khuyen-mai" className={({isActive}) => isActive ? `${styles.active}` : null}>Bài thi</NavLink>
            </div>
            <div className={styles.navItem}>
                <NavLink to="/khuyen-mai" className={({isActive}) => isActive ? `${styles.active}` : null}>Flash card</NavLink>
            </div>
            <div className={styles.navItem}>
                <NavLink to="/khuyen-mai" className={({isActive}) => isActive ? `${styles.active}` : null}>Liên hệ</NavLink>
            </div>
        </div>
    )
